import { it as rawIt } from "node:test";
const modeAllowedValues = ["serial", "parallel"];
const th = (msg) => new Error(`utils.ts error: ${msg}`);
let mode;
 ...
 */
export function determineMode(importMetaUrl) {
...
export const it = Object.assign(function (name, fn) {
    check();
